...
public class AdapterSpinnerCatGeneros extends ArrayAdapter<CatGeneros> {
    ArrayList<CatGeneros> values;
    Context context;

    public AdapterSpinnerCatGeneros(Context context, int resourceId, ArrayList values){
    ...
    @Nullable
    @Override
    public CatGeneros getItem(int position) {
